...
class LinkedList:
    ...
    def index_node(self, value) -> list:
        if value not in self.to_list():
            raise ValueError(f"Значения не существует!")
        else:
            return [i for i, val in enumerate(self.to_list()) if val == value]
...
if __name__ == '__main__':
    ...
    print(linked_list.index_node(3))
